...
class ClientPrefs {
	...
	public static var showcodes:Bool = false;
	...
	public static function saveSettings() {
		FlxG.save.data.HitboxJigsaw = HitboxJigsaw;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.HitboxJigsaw != null) {
			HitboxJigsaw = FlxG.save.data.HitboxJigsaw;
		}
		...
		if(FlxG.save.data.showcodes != null) {
			showcodes = FlxG.save.data.showcodes;
		}
