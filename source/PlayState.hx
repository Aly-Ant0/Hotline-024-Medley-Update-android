...
//			remove(bg);
	...
	override public function update(elapsed:Float)
	{
		...
		switch(curStage){
			case "covers":
				...
				if (dad.curCharacter.startsWith('nikku') && dad != null)
		...
		if (comboState == 0 && combotxt1 != null && combotxt2 != null && combotxtscoreplus != null && comboGlow != null){ // combo moment 
			combotxt1.text = rating + " x" + comboNum;
			combotxt2.text = Std.string(comboScore);
			combotxtscoreplus.text = "+" + score;
		}
		if (comboState == 1 && combotxt1 != null && combotxt2 != null && combotxtscoreplus != null && comboGlow != null){ // combo moment 2
				comboNum = 0;
				// lerp momento
				var toZero:Int = 90;
				...
				if (Math.floor(Math.abs(sicks>=100))){
		...
		if (curSong == 'Sugarcrush' && curStage == 'skatepark'){
			//octagom
	...
	//tryna do MS based judgment due to popular demand
		...
		seperatedScore.push(combo % 10);
			...
			if (comboTwn != null  && combotxt1 != null) {
				comboTwn.cancel();
			...
			if (comboTwn2 != null && combotxt2 != null) {
					comboTwn2.cancel();
